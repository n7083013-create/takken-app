...
export const takkengyohoQuickQuizzes: QuickQuiz[] = [
  ...
  },
  {
    ...
    moduleId: 'takken',
    category: 'takkengyoho',
    statement: '低廉な空家等（800万円以下）の売買媒介では、現地調査等の費用を含め、売主・買主それぞれから最大で税込33万円まで報酬を受領できる。',
    isCorrect: true,
    explanation: '正しい。2024年7月改正（報酬告示）により、対象が400万円以下→800万円以下に拡大し、報酬上限は現地調査等の費用を含め税込33万円（税抜30万円）、従来の売主のみから売主・買主双方の受領可に拡大された。',
  ...
  },
  {
    ...
    moduleId: 'takken',
    category: 'takkengyoho',
    statement: '800万円以下の低廉な空家等の売買媒介では、2024年7月改正により、売主・買主の双方から特例の報酬（現地調査費用を含め税込33万円）を受領できる。',
    isCorrect: true,
    explanation: '正しい。2024年7月改正で低廉な空家等の特例は売主のみ→売主・買主の双方に拡大し、各々から現地調査費用を含め税込33万円まで受領可能（対象は800万円以下）。',
    tags: ['報酬', '低廉な空家'],
    needsReview: true,
  },
  {
    ...
    isCorrect: false,
    explanation: '誤り。2024年7月改正により、通常報酬＋現地調査費用等の合計で税込33万円（税抜30万円）が上限である（旧19万8,000円から引上げ）。22万円ではない。',
    tags: ['報酬', '低廉な空家'],
    needsReview: true,
  },
  {
